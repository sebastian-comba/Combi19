    ...
    fetch("/iniciar", {
        ...
        .then((data) => {
            if (data.response === "bien") {
                ...
                if (data.response === "suspendido") {

                    document.getElementById("errorI").innerHTML =
                        '<small  style="color:red"><p class="errorIni">Usted ha sido borrado o suspendido.Por favor pongase en contacto con la Administracion</p></small>';
                } else {
                    document.getElementById("errorI").innerHTML =
